...
<head>
  ...
  <link href="<c:url value="/css/mobilephone/user/modifyMobilePhone.css"/>" rel="stylesheet" type="text/css" >
...
<div class="zhongti">
  ...
  <form>
    <!--手机号-->
    <div class="sjhm">
      <div class="sjhm-l">手机号码：</div>
      <div class="sjhm-r"><samp class="cl">183****3009</samp></div>
    </div>
    ...
    <!--新手机号-->
    <div class="xsjhm">
      <div class="xsjhm-l">新手机号码：</div>
      <div class="xsjhm-r"><input type="text" value="" id="" class="text2"  placeholder="输入新手机号"  /></div>
    </div>
