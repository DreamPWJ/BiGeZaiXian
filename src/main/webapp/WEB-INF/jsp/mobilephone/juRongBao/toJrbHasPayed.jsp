...
<head>
  ...
  <link href="<c:url value="/css/mobilephone/jrb/hasPayment.css"/>" rel="stylesheet" type="text/css">
  ...
  <div class="HD-dd">
    ...
    <div class="HD-dd-2" id="content_order1" style="display:none;">
      <div class="HD-dd-2-1">
        ...
        <div class="HD-dd-2-1-1">贷款金额：<samp class="HD-sam4">90</samp>&nbsp;万</div>
      </div>
      <div class="HD-dd-2-1">
        手续费：<samp class="HD-sam3">5</samp>&nbsp;万
        <div class="HD-dd-2-1-1">总金额：<samp class="HD-sam4">95</samp>&nbsp;万</div>
      </div>

      <div class="HD-xx1">
        <div class="HD-xx1-1">
          <div class="HD-xx1-1-1"><a href="/BiGeZaiXian/jurongbao/toJrbRepaymentDetail">还款明细</a></div>
        </div>
        <div class="HD-xx1-1">
  ...
  <div class="HD-dd">
    <div class="HD-dd-1" id="title_order2">
        ...
        <div class="HD-dd-1-z">
          ...
          <div class="HD-dd-1-z-1"><samp class="HD-sam2">105</samp>&nbsp;万</div>
        </div>
    </div>
    <!--订单展现信息-->
    <div class="HD-dd-2" id="content_order2" style="display:none;">
      ...
      <div class="HD-dd-2-1">
        手续费：<samp class="HD-sam3">5</samp>&nbsp;万
        <div class="HD-dd-2-1-1">总金额：<samp class="HD-sam4">105</samp>&nbsp;万</div>
      </div>
  ...
  <div class="HD-dd">
    <div class="HD-dd-1" id="title_order3">
        ...
        <div class="HD-dd-1-z">
          ...
          <div class="HD-dd-1-z-1"><samp class="HD-sam2">70</samp>&nbsp;万</div>
        </div>
    </div>
    <!--订单展现信息-->
    <div class="HD-dd-2" id="content_order3" style="display:none;">
      ...
      <div class="HD-dd-2-1">
        手续费：<samp class="HD-sam3">5</samp>&nbsp;万
        <div class="HD-dd-2-1-1">总金额：<samp class="HD-sam4">70</samp>&nbsp;万</div>
      </div>
