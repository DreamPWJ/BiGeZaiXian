...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <link href="<c:url value="/css/mobilephone/jrb/InAuditShow.css"/>" rel="stylesheet" type="text/css">
  ...
  <div class="HD-dd">
    <div class="HD-dd-1" id="title_order1">
        ...
        <div class="HD-dd-1-z">
          ...
          <div class="HD-dd-1-z-1"><samp class="HD-sam2">审核中</samp></div>
        </div>
    </div>
    <!--订单展现信息-->
    <div class="HD-dd-2" id="content_order1" style="display:none;">
      ...
      <div class="HD-dd-2-2">
        ...
        <div class="HD-dd-2-1-1">总金额(含手续费)：<samp class="HD-sam4">70</samp>&nbsp;万</div>
      </div>
