...
<!-- content ----------- 开始 -->
<div class="banner"><img src="<c:url value='/images/pc/informationcenter/banner03.jpg'/>" alt="banner" width="100%"></div>
<div class="content">
    <!-- Nav tabs -->
   <%-- <ul class="nav nav-tabs" role="tablist">
    ...
    <div class="tab-content">
        ...
        &lt;%&ndash;    <div class="L1-2"><img src="<c:url value='/images/pc/news/pt001.png'/> "/>行情资讯</div>&ndash;%&gt;
      ...
      &lt;%&ndash;      <div class="L1-2"><img src="<c:url value='/images/pc/news/pt001.png'/> "/>行业资讯</div>&ndash;%&gt;
    ...
    <!--平台-->
    <div class="flat">
        <div><a href="javascript:void(0)" class="btn btn-color">平&nbsp;&nbsp;&nbsp;台</a></div>
        <c:forEach var="item" items="${news003001001}" begin="0" end="2" varStatus="status">
            <div class="news">
                <!--标题-->
                <div class="title"><span>${item.TITLE}</span></div>
                <!--内容-->
                <div class="con">
                    <div class="img"><a><img src="<c:url value='/images/pc/informationcenter/${ status.index+1}.jpg'/>" width="228" height="140" alt=""></a></div>
                    <div class="value">
                        <div class="summary">${item.SUMMARY}<span class="detail">
                                <a target="_blank" href="<c:url value='/index/tonews?id=${item.ID}'/>">【详情】</a>
                            </span></div>
                    </div>
                </div>
                <div style="clear:both;"></div>
        ...
        <!--点击更多-->
        <div class="pthd">
            <div class="pthd-z"><a href="javascript:void(0)" class="pingtai">更多请点击此处</a></div>
        </div>
    </div>

    <!--行业-->
    <div class="flat">
        <div><a href="javascript:void(0)" class="btn btn-color">行&nbsp;&nbsp;&nbsp;业</a></div>
        <c:forEach var="item" items="${news003002}" begin="0" end="2" varStatus="status">
            <div class="news">
                <!--标题-->
                <div class="title"><span>${item.TITLE}</span></div>
                <!--内容-->
                <div class="con">
                    <div class="img"><a><img src="<c:url value='/images/pc/informationcenter/${ status.index+4}.jpg'/>" width="228" height="140" alt=""></a></div>
                    <div class="value">
                        <div class="summary">${item.SUMMARY}<span class="detail">
                                <a target="_blank" href="<c:url value='/index/tonews?id=${item.ID}'/>">【详情】</a>
                            </span></div>
        ...
        <!--点击更多-->
        <div class="pthd">
            <div class="pthd-z"><a href="javascript:void(0)"  class="hangye">更多请点击此处</a></div>
        </div>
    </div>
    ...
    <!--市场-->
    <div class="flat">
        <div><a href="javascript:void(0)" class="btn btn-color">市&nbsp;&nbsp;&nbsp;场</a></div>
        <c:forEach var="item" items="${news003003001}" begin="0" end="2" varStatus="status">
            <div class="news">
                <!--标题-->
                <div class="title"><span>${item.TITLE}</span></div>
                <!--内容-->
                <div class="con">
                    <div class="img"><a><img src="<c:url value='/images/pc/informationcenter/${ status.index+7}.jpg'/>" width="228" height="140" alt=""></a></div>
                    <div class="value">
                        <div class="summary">${item.SUMMARY}<span class="detail">
                                <a target="_blank" href="<c:url value='/index/tonews?id=${item.ID}'/>">【详情】</a>
                            </span></div>
        ...
        <!--点击更多-->
        <div class="pthd">
            <div class="pthd-z"><a href="javascript:void(0)" class="shichang">更多请点击此处</a></div>
        </div>
    </div>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane " id="platform">
            ...
            <div class="L1-2"><img src="<c:url value='/images/pc/news/pt001.png'/> "/><span class="newMain">资讯中心 》</span>平台资讯</div>
            <!--平台内容-->
            <c:forEach var="item" items="${news003001001}" varStatus="status">
                <div class="L2">
                    <div class="L2-t"><a href="<c:url value='/index/tonews?id=${item.ID}'/> " target="_blank"><img
                            <%--src="${item.TITLEIMAGE}"--%>
                            src="<c:url value='/images/pc/informationcenter/${ status.index+1}.jpg'/>"
                            width="228"
                            height="140"/></a></div>
                    <div class="L2-z">
                        <div class="L2-z1">
                        ...
                        <div class="L2-z3"><a target="_blank" href="<c:url value='/index/tonews?id=${item.ID}&code=平台资讯'/>">[详情]</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
        ...
        <div role="tabpanel" class="tab-pane " id="market">
            <div class="L1-2"><img src="<c:url value='/images/pc/news/pt001.png'/> "/><span class="newMain">资讯中心 》</span><span>行业资讯</span></div><!--行情内容-->
            <%--    <div class="L1-2"><img src="<c:url value='/images/pc/news/pt001.png'/> "/>行情资讯</div>--%>
            <c:forEach var="item" items="${news003002}" varStatus="status">
                <div class="L2">
                    <div class="L2-t"><a
                            href="<c:url value='/index/tonews?id=${item.ID}'/>"  target="_blank"><img
                           <%-- src="${item.TITLEIMAGE}"--%>
                    ...
                    <div class="L2-z">
                        ...
                        <div class="L2-z3"><a
                                href="<c:url value='/index/tonews?id=${item.ID}&code=行业资讯'/>"  target="_blank">[详情]</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
        ...
        <div role="tabpanel" class="tab-pane " id="industry">
            ...
            <div class="L1-2"><img src="<c:url value='/images/pc/news/pt001.png'/> "/><span class="newMain">资讯中心 》</span><span>市场资讯</span></div><!--行业内容-->
            <%--      <div class="L1-2"><img src="<c:url value='/images/pc/news/pt001.png'/> "/>行业资讯</div>--%>
            <c:forEach var="item" items="${news003003001}"  varStatus="status">
                <div class="L2">
                    <div class="L2-t"><a
                            href="<c:url value='/index/tonews?id=${item.ID}'/>"  target="_blank"><img
                           <%-- src="${item.TITLEIMAGE}"--%>
                    ...
                    <div class="L2-z">
                        ...
                        <div class="L2-z3"><a
                                href="<c:url value='/index/tonews?id=${item.ID}&code=市场资讯'/>"  target="_blank">[详情]</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
